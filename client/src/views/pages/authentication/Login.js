...
const ToastContent = ({ name, role }) => (
    <Fragment>
        ...
        <div className="toastify-body">
            <span>
                You have successfully logged in as an {role} user to My Manager.
                        ...
                        if ((res.userData.permission)[item] == true) {
                            ...
                            if (item == "myCMA") {
                                newAbility.push(
                                    ...
                                    action: 'manage',
                                    subject: 'mycma/birthday'
                                }, {
                                    action: 'manage',
                                    subject: 'mycma/expired'
                                }, {
                                    action: 'manage',
                                    subject: 'mycma/statistics'
                                }, {
                                    action: 'manage',
                                    subject: 'mycma/certifications'
                                })
                            }
                            newAbility.push({
                                action: 'manage',
