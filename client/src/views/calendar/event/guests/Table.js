...
import { addNewGuests } from '../store'
...
const Table = (props) => {
  ...
  const addUser = (e) => {
    dispatch(addNewGuests(e.selectedRows))
  }
  // ** Get data on mount
  useEffect(() => {
    dispatch(getAllData())
  ...
  const dataToRender = () => {
    ...
    // console.log(props)
    let allData = []
    return allData.concat(props.allLeads, props.allClients, props.allVenders, props.allEmployees, props.allRelationships)
  }
