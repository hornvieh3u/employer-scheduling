                ...
                <CardBody>
                    <div className="d-flex justify-content-between align-items-start">
                        ...
                        <div className="d-flex justify-content-center">
                            ...
                            <span className="fw-bolder display-5 mb-0 text-primary"></span>
                            <sub className="pricing-duration font-small-4 ms-25 mt-auto mb-2"></sub>
                        </div>
                    </div>
                ...
                <ModalBody className="px-5 pb-3">
                    ...
                    <div className="d-flex justify-content-between align-items-center flex-wrap">
                        <div className="d-flex justify-content-center me-1 mb-1">
                            ...
                            <h1 className="fw-bolder display-4 mb-0 text-primary me-25"></h1>
                            <sub className="pricing-duration font-small-4 mt-auto mb-2"></sub>
                        </div>
                        <Button
                            outline
                            color="danger"
