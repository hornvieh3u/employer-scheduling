...
export const ExpenseCategoryList = () => {
  return async (dispatch) => {
    try {
      let response = await API.get(`${baseUrl}/api/expenses/list_category/${getUserId()}`, {
        headers: getHeaders()
      });
      if (response.data && response.status === 200) {
        dispatch({
...
//   return dispatch => {
//      API.put(`${baseUrl}/api/expenses/update_category/${localStorage.getItem("user_id")}/${id}`, data, {
//       headers : {
//         "Authorization" : `Bearer ${localStorage.getItem("accessToken")}`,
//         "content-type" : "application/json",
//       }
...
export const trashCategory = (id) => {
  return (dispatch) => {
    API.delete(`${baseUrl}/api/expenses/remove_category/${getUserId()}/${id}`, {
      headers: {
        Authorization: `Bearer ${localStorage.getItem('accessToken')}`
      }
    }).then((res) => {
...
export const GetMonthlyPaymentList = () => {
  return async (dispatch) => {
    try {
      let response = await API.get(`${baseUrl}/api/finance/monthly_pay_list/${getUserId()}`, {
        headers: getHeaders()
      });
      if (response.data && response.status === 200) {
        dispatch({
...
export const ExpenseBreakDownList = () => {
  return async (dispatch) => {
    try {
      let response = await API.get(`${baseUrl}/api/finance/expense_breakdown/${getUserId()}`, {
        headers: getHeaders()
      });
      if (response.data && response.status === 200) {
        dispatch({
...
export const moveMail = (id) => {
  return (dispatch) => {
    API.delete(`${baseUrl}/api/email_compose/remove_template/${getUserId()}/${id}`, {
      headers: getHeaders()
    }).then((res) => {
...
export const GetFolderList = () => {
  return async (dispatch) => {
    try {
      let response = await API.get(`${baseUrl}/api/email_compose/category_list/${getUserId()}`, {
        headers: getHeaders()
      });
      if (response.data && response.status === 200) {
        dispatch({
...
export const fetchAllCCAction = (page, perPage) => {
  return async (dispatch) => {
    try {
      ...
      let response = await API.get(`${baseUrl}/api/finance/fetch-all-cc/${getUserId()}`, {
        params: {
          page,
          perPage
        },
...
export const getExpenseByCategoryAction = () => {
  return async (dispatch) => {
    try {
      ...
      let response = await API.get(`${baseUrl}/api/finance/expense-state/${getUserId()}`, {
        headers: getHeaders()
      });
...
export const getTodaysExpenseAction = () => {
  return async (dispatch) => {
    try {
      ...
      let response = await API.get(`${baseUrl}/api/finance/expense-today/${getUserId()}`, {
        headers: getHeaders()
      });
...
export const getWeeklyExpenseAction = () => {
  return async (dispatch) => {
    try {
      ...
      let response = await API.get(`${baseUrl}/api/finance/expense-weekly/${getUserId()}`, {
        headers: getHeaders()
      });
...
export const getMonthlyExpenseAction = () => {
  return async (dispatch) => {
    try {
      ...
      let response = await API.get(`${baseUrl}/api/finance/expense-monthly/${getUserId()}`, {
        headers: getHeaders()
      });
...
export const getYearlyExpenseAction = () => {
  return async (dispatch) => {
    try {
      ...
      let response = await API.get(`${baseUrl}/api/finance/expense-yearly/${getUserId()}`, {
        headers: getHeaders()
      });
...
export const getExpenseReportFilterAction = (paymentSystem, month, year, page) => {
  return async (dispatch) => {
    try {
      ...
      let response = await API.get(`${baseUrl}/api/finance/expense-report/${getUserId()}`, {
        params: {
          paymentSystem,
          month,
          year,
...
export const getTodaysIncomeAction = () => {
  return async (dispatch) => {
    try {
      ...
      let response = await API.get(`${baseUrl}/api/finance/income-today/${getUserId()}`, {
        headers: getHeaders()
      });
...
export const getWeeklyIncomeAction = () => {
  return async (dispatch) => {
    try {
      ...
      let response = await API.get(`${baseUrl}/api/finance/income-weekly/${getUserId()}`, {
        headers: getHeaders()
      });
...
export const getMonthlyIncomeAction = () => {
  return async (dispatch) => {
    try {
      ...
      let response = await API.get(`${baseUrl}/api/finance/income-monthly/${getUserId()}`, {
        headers: getHeaders()
      });
...
export const onTimeExpenseRequest = (expenseType) => {
  return async (dispatch) => {
    try {
      ...
      let response = await API.get(`${baseUrl}/api/finance/expense-by-type/${getUserId()}`, {
        params: {
          type: expenseType
        },
        headers: getHeaders()
...
export const getYearlyIncomeAction = () => {
  return async (dispatch) => {
    try {
      ...
      let response = await API.get(`${baseUrl}/api/finance/income-yearly/${getUserId()}`, {
        headers: getHeaders()
      });
...
export const getIncomeReportFilterAction = (paymentSystem, month, year) => {
  return async (dispatch) => {
    try {
      ...
      let response = await API.get(`${baseUrl}/api/finance/income-report/${getUserId()}`, {
        params: {
          paymentSystem,
          month,
          year
...
export const filterDataForPNLExpenseAction = (payload) => {
  return async (dispatch) => {
    try {
      ...
      let response = await API.get(`${baseUrl}/api/finance/pnl-expense-report/${getUserId()}`, {
        params: { ...payload },
        headers: getHeaders()
      });
...
export const filterDataForPNLMembershipAction = (payload) => {
  return async (dispatch) => {
    try {
      ...
      let { data } = await API.get(`${baseUrl}/api/finance/pnl-membership-report/${getUserId()}`, {
        params: { ...payload },
        headers: getHeaders()
      });
...
export const filterDataForPNLRecurringByInHouse = (payload) => {
  return async (dispatch) => {
    try {
      ...
      let { data } = await API.get(`${baseUrl}/api/finance/pnl-in-house-recurring/${getUserId()}`, {
        params: { ...payload },
        headers: getHeaders()
      });
...
export const deleteCategoryAction = ({ id }) => {
  return async (dispatch) => {
    try {
      ...
      let response = await API.get(`${baseUrl}/api/finance/category-delete/${getUserId()}`, {
        params: {
          id
        },
        headers: getHeaders()
...
export const getLastMonthExpenseAction = () => {
  return async (dispatch) => {
    try {
      ...
      let response = await API.get(`${baseUrl}/api/finance/last-month-expense/${getUserId()}`, {
        headers: getHeaders()
      });
