      ...
      if (query.length && !filteredChat.length) {
        ...
        return arrToMap.map(item => {
          ...
          return (
            ...
            >
              <Avatar img={require('@src/assets/images/avatars/avatar-blank.png').default} imgHeight={42} imgWidth={42} status={item.status} />
            ...
            <li key={item.fullName}>
              {
                ...
                : <Avatar color="primary" imgHeight={42} imgWidth={42} img={require('@src/assets/images/avatars/avatar-blank.png').default} />
              }
              <div className='chat-info flex-grow-1'>
