...
const ComposePopup = props => {
  ...
  return (
    ...
    <button type="button" class="btn btn-outline-primary " disabled>Primary button</button>
            ...
            <div>
              <Row>
                <Col xl="12" className="p-2"><button type="button" class="btn btn-primary rounded-0">Basic</button><button type="button" class="btn btn-outline-primary rounded-0" disabled>Builder</button></Col>
                <Col xl="4">      <div className='compose-mail-form-field'>
            ...
            <div className="p-2">
              <Row >
                <Col xl="2">  <IoGitMergeOutline onClick={toggle} className="cursor-pointer" size={20} /></Col>
                <Col xl="1" className="mx-1" ><p class="fs-4 ">      <Label className="form-label" for="startDate">
                                Scheduled
                            </Label></p></Col>
                <Col xl="3" >
