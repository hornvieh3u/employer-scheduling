...
const RepeatingForm = ({ disabled }) => {
    ...
    const deleteForm = (e) => {
        ...
        if (!disabled) {
            setRecipients(
                recipients.filter((x) => x.id.toString() != e.target.id)
            )
            setCount(count + 1)
        }
    }
                                        ...
                                        >
                                            ...
                                            <Col md={2}>
                                                <div className="mt-2">
                                                    <Select
                                                        value={
                                                            roleOptions.find((x)=>x.value===recipients[i].roleOption)
                                                        }
                                                        defaultValue={roleOptions.find((x)=>x.value===recipients[i].roleOption)}
