        ...
        <Card key={item.name} className="ecommerce-card">
          ...
          <CardBody>
            <div className="item-name">
              <h6 className="mb-0">
                <Link to={`/ecommerce/product-detail/${item.slug}`}>{item.name}</Link>
              </h6>
            ...
            <span className="text-primary mb-1">Start Date: 12/12/2022</span>
            <span className="text-warning mb-1">Expiry Date: 12/12/2023</span>
          ...
          <div className="item-options text-center">
            ...
            <Button className="mt-1 remove-wishlist" color="light" onClick={() => {}}>
