...
// ** Actions
import { updateTask, handleSelectTask } from '../../apps/kanban/store';
import { getSelectedWorkspaceData } from '../../apps/workspace/store';
import LabelManagementModal from '../label-management/LabelManagementModal';
        ...
        <PerfectScrollbar options={{ wheelPropagation: false }}>
          <ModalBody className="flex-grow-1 pb-sm-0 pb-3">
            ...
            <div className="mb-1">
              ...
              <Button onClick = {() => setLabelManagementFlag(true)}>
                <Settings size={14} className="me-25" />
              </Button>
              <Select
                isMulti
                value={labels}
