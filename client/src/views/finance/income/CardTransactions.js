...
const CardTransactions = () => {
  ...
  return (
    <Card className='card-transaction'>
      <CardHeader>
        <CardTitle tag='h4'>Income Type</CardTitle>
      ...
      <CardBody>
        ...
        <div className='pt-2'>
          <div key={transactionsArr[2].title} className='transaction-item'>
            <div className='d-flex'>
              <Avatar className='rounded' color={transactionsArr[2].color} icon={<Icon.TrendingUp size={18} />} />
              <div>
                <h6 className='transaction-title'>Total</h6>
                {/* <small>{transactionsArr[2].subtitle}</small> */}
              </div>
            </div>
            <div className={`fw-bolder ${transactionsArr[2].down ? 'text-danger' : 'text-success'}`}>{transactionsArr[2].amount}</div>
          </div>
        </div>
        </CardBody>
    </Card>
