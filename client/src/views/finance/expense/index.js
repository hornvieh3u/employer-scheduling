...
// ** Reactstrap Imports
import {
    Row, Col, Card, ListGroupItem, CardHeader, ListGroup, CardText, Alert, Dropdown,
    DropdownToggle,
    DropdownMenu,
    DropdownItem
} from 'reactstrap'
...
const Expense = () => {
    ...
    const monthselect = ["Januray", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"]
    const daywisedata = ["January 1 ,2022", "January 2 ,2022", "January 3 ,2022", "January 4 ,2022", "January 5 ,2022", "January 6 ,2022"]
    const monthwisedata = ["January ,2022", "February ,2022", "March ,2022", "April ,2022", "May ,2022", "June ,2022", "July ,2022", "August ,2022", "September ,2022", "October ,2022", "November ,2022", "December ,2022"]
    ...
    const tredtextarrray = ["this month you spent $500 more on transport from last month", "your food expenses has increased by 53% from last month", " this month you spent $500 on Transport."]
    ...
    return (
        <Fragment>
            ...
            <ApexRadarChart />
                ...
                <Col xl='4' lg='12'>
                    <ApexDonutChart heading="Expense Proportion" subheading="Total Expenses - $1234" label={donutlabel} data={donutdata} />
                </Col>
                <Col xl="5" lg="12">
                    <Card
                        style={{
            ...
            <ApexDonutChart heading="Expense Proportion" subheading="Total Expenses - $1234" labeldata={['EMI','RENTS','OPERATIONS','SALLARY']} />
                ...
                <Col xl='3' lg='12'>
                    <ApexBarChart direction={isRtl ? 'rtl' : 'ltr'} info={colors.info.main} heading="Month Wise Expense" subheading="---" />
                </Col>
            ...
            <p>
              ...
              <a href='https://github.com/apexcharts/react-apexcharts' target='_blank' rel='noopener noreferrer'>
                ...
                <Col sm='2'>
                    ...
                    <select onChange={handleselect} class="form-select" aria-label="Default select example" disabled={switchstate && "disabled"}>
                ...
                <Col sm='12'>
                    <ApexAreaChart data={areachartdata} heading="Category Expenses" subheading="transport" direction={isRtl ? 'rtl' : 'ltr'} />
                </Col>
